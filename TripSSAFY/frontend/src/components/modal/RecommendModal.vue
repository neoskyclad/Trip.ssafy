<template>
 ...
 <!-- Step 1~3: 입력 단계 -->
    ...
    <div v-else-if="step === 5">
      ...
      <div class="bg-gray-100 p-4 rounded text-sm text-center">
        더 똑똑한 여행 계획을 세워보세요!
        <button @click="goToSignup" class="text-blue-600 underline ml-1">
          회원가입
        </button>
      </div>
    </div>
...
const placeholders = ["예: 제주도", "예: 친구", "예: 힐링"];
...
const requestRecommendation = async () => {
  ...
  try {
    ...
    console.log("AI 추천 결과:", recommendation.value);
  } catch (err) {
